  ...
  cases: [
    {
      ...
      brand: "Nomad Bites",
      logo: nomadBitesLogo,
      summary: "A ghost kitchen brand with strong food — but zero digital presence and stagnant order volume.",
      metrics: [
        { value: "+210%", label: "Order volume" },
        { value: "8 wks", label: "To relaunch" },
        { value: "3x", label: "Avg basket size" },
      ],
      problem:
    ...
    },
    {
      ...
      brand: "Grillhaus Co.",
      logo: grillhausLogo,
      summary: "Supporting franchise brands through brand consistency, operational standardization, and quality assurance.",
      metrics: [
    ...
    },
    {
      ...
      outcome: "Professional food photography, review acquisition campaign, and optimized listing copy drove 160% revenue growth.",
    },
    {
      id: "big-table",
      category: "QSR",
      ...
      problem: "Inconsistent social presence and lack of online booking visibility resulted in low weekend reservations.",
      outcome: "Strategic social content, Google Business optimization, and a streamlined booking flow increased weekend covers by 2.4x in 8 weeks.",
    },
    {
      id: "noodle-lab",
      category: "QSR",
      ...
      metrics: [
        { value: "+85%", label: "App order volume in 8 weeks" },
        { value: "41%", label: "Abandonment reduction" },
        { value: "29%", label: "AOV increase" },
      ],
      problem: "High cart abandonment rate and poor in-app discoverability were limiting repeat customer orders.",
      outcome: "Loyalty incentive program, targeted push notifications, and menu restructuring boosted app orders by 85%.",
    },
    {
      id: "harbor-house",
      ...
      problem: "No CRM strategy and inconsistent post-visit engagement led to low customer retention and infrequent repeat visits.",
      outcome: "Personalized email journeys, birthday offers, and a tiered loyalty scheme tripled the return customer rate.",
    },
